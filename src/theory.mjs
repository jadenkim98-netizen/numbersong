...
export function stageGoal(mode, name) {
  ...
  if (name.startsWith("2D")) return "Meet 2D — the 2 chord made major with a ♭7, the five-chord of 5. Its ♯4 is 5's leading tone, so where 2- drifts toward 5, 2D shoves. On the pad, tap 2 and then the D chip: same root as 2-, one note different.";
  ...
  if (name.startsWith("Secondary")) return "1D, 2D, 3D and 6D all live — tap the root, then D for the dominant. The new sound is the chain — 3D to 6D to 2D to 5D, every chord the five of the next, falling round the circle toward home.";
